...
int main() {
    ...
    //Loop through the string until the end and add up all the words that only contain lowercase characters:
    while (a_string[i] != '\0') {
    ...
    //Loop through the original string until a space is encountered and copy each letter into a buffer string:
    while (a_string[j] != ' ') {
