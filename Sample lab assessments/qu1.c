...
long long int* PromptTheUserToEnterThreeIntegerNumbers() {
    long long int* integer_numbers = (long long int*)malloc(3 * sizeof(long long int));

    printf("Enter three integer numbers: ");
    for (unsigned short int integer_number = 0; integer_number < 3; integer_number++) scanf("%lld", &integer_numbers[integer_number]);
...
long long int TheSmallestValueAmongThem(long long int* integer_numbers) {
    ...
    for (unsigned short int integer_number = 1; integer_number < 3; integer_number++) if (integer_numbers[integer_number] < the_smallest_value_among_them) the_smallest_value_among_them = integer_numbers[integer_number];
