...
void PrintTheLastToFirstElementOfTheArrayIn1Line(ssize_t *an_array_of_4_integers) {
...
ssize_t* SortTheArrayInAscendingOrderUsingTheSelectionSortAlgorithm(ssize_t *an_array_of_4_integers) {
    
    for (unsigned char element = 0; element < 4; ++element) {
        for (unsigned char ascended_element = element + 1; ascended_element < 4; ++ascended_element) {
            if (element[an_array_of_4_integers] > ascended_element[an_array_of_4_integers]) {
                ssize_t order = element[an_array_of_4_integers];
                element[an_array_of_4_integers] = ascended_element[an_array_of_4_integers];
...
int main() {
    ...
    ssize_t *an_array_of_4_integers = AskTheUser2EnterValues4Them(CreateAnArrayOf4Integers());
    ...
    PrintTheArray(SortTheArrayInAscendingOrderUsingTheSelectionSortAlgorithm(an_array_of_4_integers));
